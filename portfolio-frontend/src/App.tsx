...
const HeaderSection = () => (
  <header
    id="home"
    className="mb-20 px-6 py-10 bg-gray-300 flex justify-between items-center scroll-mt-24"
  >
    <div>
...
function App() {
  ...
  return (
    <div className="font-sans">
      {/* NAVIGATION */}
      <nav className=" z-[50] w-full bg-gray-500 font-heading flex items-center justify-end py-4 shadow-md">
