...
const HeaderSection = () => (
  ...
  >
    <div>
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-green-700 font-semibold">
        Filimon Alem
      </h1>
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-green-700 font-semibold">
        Software Engineer
      </h2>
    </div>
